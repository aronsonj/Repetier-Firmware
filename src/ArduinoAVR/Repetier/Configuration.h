...
#define EXT0_STEPS_PER_MM (95*2) //DT_PERFORMANCE 32TH STEPPING
...
#define EXT0_PID_P   10.32 //24
/** I-gain. Overridden if EEPROM activated.
*/
#define EXT0_PID_I   0.46 //0.88
/** D-gain.  Overridden if EEPROM activated.*/
#define EXT0_PID_D 57.34 //80
...
*/
#define CARRIAGE_HORIZONTAL_OFFSET 28
...
/** Maximum feedrate, the system allows. Higher feedrates are reduced to these values.
    The axis order in all axis related arrays is X, Y, Z
     Overridden if EEPROM activated.
    */
#define MAX_FEEDRATE_X 320
#define MAX_FEEDRATE_Y 320
#define MAX_FEEDRATE_Z 320
...
*/
#define DOUBLE_STEP_DELAY 1.9 // time in microseconds
...
#define UI_PRINTER_NAME "Kossel Clear"
#define UI_PRINTER_COMPANY "BlueEagleLabs"
